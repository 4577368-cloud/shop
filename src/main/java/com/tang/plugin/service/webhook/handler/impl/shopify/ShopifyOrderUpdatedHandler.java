...
@Slf4j
@Component
public class ShopifyOrderUpdatedHandler extends AbstractShopifyOrderWebhookHandler {

    @Override
    public boolean supports(ShopifyWebhookEventEnum eventType) {
        return eventType == ShopifyWebhookEventEnum.ORDERS_UPDATED;
    }

    @Override
    public void handle(String shopDomain, String webhookId, String rawPayload) {
        ingestOrderWebhook(shopDomain, webhookId, rawPayload, "orders/updated");
    }
}
